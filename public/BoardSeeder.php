...
class BoardSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pronoun_index = $emotion_index + 12;
        ...
        $user->words()->createMany([
            ['id' => $board_index, 'text' => '', 'color' => $default_color],
        ...
        $user->folders()->find(5)->words()->attach([
            ...
            $pronoun_index + 2 => ['board_x' => 2, 'board_y' => 1],
            $pronoun_index + 3 => ['board_x' => 3, 'board_y' => 1],
            $pronoun_index + 4 => ['board_x' => 4, 'board_y' => 1],
            $pronoun_index + 5 => ['board_x' => 5, 'board_y' => 1]
        ]);
        ...
        $user->words()->createMany([
            ...
            ['id' => $food_fruit + 2, 'text' => 'Fruit', 'color' => $default_color],
            ...
            ['id' => $food_fruit + 8, 'text' => 'Plumb', 'color' => $default_color],
        ...
        $user->folders()->find(22)->words()->attach([
            ...
            $food_fruit + 3 => ['board_x' => 3, 'board_y' => 1],
            $food_fruit + 4 => ['board_x' => 4, 'board_y' => 1],
        ...
        $user->folders()->find(21)->words()->attach([
            ...
            $food_drinks + 2 => ['board_x' => 2, 'board_y' => 1],
            $food_drinks + 3 => ['board_x' => 3, 'board_y' => 1],
            $food_drinks + 4 => ['board_x' => 4, 'board_y' => 1],
